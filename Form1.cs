...
namespace HomeInventoryProject
{
    public partial class frmInventory : Form
    {
        ...
        private void InventoryForm_Load(object sender, EventArgs e)
        {
            ...
            lblPhoteFile.DataBindings.Add("Text", inventoryTable, "PhotoFile");
        ...
        private void btnLoadPhoto_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblPhoteFile.Text = dlgOpen.FileName;
                    ShowPhoto();
                }
            }
            catch (Exception ex)
        ...
        {
            //display photo
            if (!lblPhoteFile.Text.Equals(""))
            {
                try
                {
                    picItem.Image = Image.FromFile(lblPhoteFile.Text);
                }
                catch (Exception ex)
                {
        ...
        private void PrintInventory(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString(txtPurchaseCost.Text, myFont, Brushes.Black, e.MarginBounds.X + 150, y);
